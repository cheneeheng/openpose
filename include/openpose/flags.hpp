...
DEFINE_string(custom_net_input_layer,   "",             "Experimental, runs network from layerX. Layer name.");
DEFINE_string(custom_net_output_layer,  "",             "Experimental, uses output from layer X. Blob name. Also to ensure heatmap size is correct.");
// OpenPose Face
